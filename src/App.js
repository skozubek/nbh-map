...
class App extends Component {
  ...
  fetchPlaces = () => {
    ...
    fetch(`https://api.foursquare.com/v2/venues/search?ll=${this.state.position.lat},${this.state.position.lng}&query=beach&v=20180323&limit=8&intent=browse&radius=150000&client_id=${FSQ_ID}&client_secret= ${FSQ_SECRET}`)
      .then((response) => {
